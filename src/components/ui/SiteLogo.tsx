...
export function SiteLogo({ size = 'md', className }: SiteLogoProps) {
  return (
    ...
    >
      ...
      />
      {/* 左侧书页线条 */}
      <line x1="7" y1="9" x2="13" y2="9" className="stroke-primary/60" strokeWidth="1" strokeLinecap="round" />
      <line x1="7" y1="13" x2="13" y2="13" className="stroke-primary/60" strokeWidth="1" strokeLinecap="round" />
      <line x1="7" y1="17" x2="11" y2="17" className="stroke-primary/60" strokeWidth="1" strokeLinecap="round" />
      {/* 星星装饰 */}
      <path
